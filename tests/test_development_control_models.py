...
from development_control import PatchVerdict as LegacyPatchVerdict
from development_control.models import AgentDecision, CodeChangeProposal, PatchVerdict
...
def test_existing_security_guard_patch_verdict_remains_backward_compatible() -> None:
    result = validate_patch(PATCH)
    assert isinstance(result, LegacyPatchVerdict)

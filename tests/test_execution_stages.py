...
def _sandbox(monkeypatch: pytest.MonkeyPatch, tmp_path) -> ProjectDatabase:
    ...
    monkeypatch.setenv("BYBIT_TESTNET_API_KEY", "testnet-key")
    monkeypatch.setenv("BYBIT_TESTNET_API_SECRET", "testnet-secret")
...
def test_live_status_is_hard_blocked_even_when_legacy_flags_are_set(tmp_path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("BYBIT_MAINNET_API_KEY", "mainnet-test-key")
    monkeypatch.setenv("BYBIT_MAINNET_API_SECRET", "mainnet-test-secret")

...
install -m 0644 "$ROOT/deploy/vps/systemd/sharipovai-monthly-performance.service" /etc/systemd/system/sharipovai-monthly-performance.service
install -m 0644 "$ROOT/deploy/vps/systemd/sharipovai-monthly-performance.timer" /etc/systemd/system/sharipovai-monthly-performance.timer
systemd-analyze verify /etc/systemd/system/sharipovai-monthly-performance.service /etc/systemd/system/sharipovai-monthly-performance.timer

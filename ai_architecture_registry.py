...
CANONICAL_AI_ORGANS: tuple[AIOrgan, ...] = (
    AIOrgan(
        ...
        ("coordination", "supervision", "health_monitoring", "recovery_orchestration", "task_routing", "development_change_orchestration"),
    ...
    AIOrgan(
        ...
        ("lessons", "mistakes", "rules", "exams", "improvement_proposals", "repair_memory", "few_shot_curation"),
    ...
    AIOrgan(
        ...
        ("access_control", "secret_safety", "policy_guard", "real_order_lock", "security_alerts", "patch_policy", "protected_path_guard"),

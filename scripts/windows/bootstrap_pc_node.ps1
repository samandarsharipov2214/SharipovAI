...
try {
    ...
    Invoke-Step "BACKUP" (Join-Path $ProjectRoot "scripts\windows\start_backup.ps1") @("-ProjectRoot", $ProjectRoot)
    Invoke-Step "WEB NODE" (Join-Path $ProjectRoot "scripts\windows\start_pc_node.ps1") @("-ProjectRoot", $ProjectRoot)
